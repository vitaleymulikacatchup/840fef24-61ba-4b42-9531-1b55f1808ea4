...
export const metadata: Metadata = {
  ...
  description: "Experience exceptional cuisine at Bella Vista. Award-winning chefs, fresh ingredients, elegant atmosphere. Make your reservation today.",
  keywords: "fine dining, restaurant, gourmet food, chef, reservations, Italian cuisine",
  openGraph: {
    title: "Bella Vista - Fine Dining Restaurant",
    description: "Experience exceptional cuisine at Bella Vista. Award-winning chefs, fresh ingredients, elegant atmosphere.",
